...
######################################################
# NOTE: This script is adapted from the following refs
# https://github.com/mesnilgr/iclr15/blob/master/scripts/data.sh
# https://github.com/vinhkhuc/kaggle-sentiment-popcorn/blob/master/scripts/prepare_data.sh
######################################################
